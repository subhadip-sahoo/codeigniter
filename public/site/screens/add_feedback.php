                    ...
                    <form class="form-horizontal" action="add" name="create_page" id="share_link" method="POST">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="dimension" class="form-control">
                                    ...
                                    <option value="<?php echo $dimension->id_questionnaire; ?>" <?php echo set_select('dimension', $dimension->id_questionnaire); ?>><?php echo $dimension->question; ?></option>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
                                </select> 
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="score_range" class="form-control">
                                    ...
                                    <option value="4-12" <?php echo set_select('score_range', '4-12'); ?>>4-12</option>
                                    <option value="13-20" <?php echo set_select('score_range', '13-20'); ?>>13-20</option>
                                </select> 
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="feedback" class="ckeditor" cols="70"><?php echo set_value('feedback'); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <input type="submit" class="btn btn-danger" value="Create Feedback" name="add_feedback">
                            </div>
                        </div>
                    </form>
                </section>
