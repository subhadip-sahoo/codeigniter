...
<head>
    ...
    <title>SMGHealth :: Reset Password</title>
                            ...
                            <form role="form" action="" method="POST" class="form-signin">
                                <fieldset>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="input-group"> <span class="input-group-addon"> <i class="fa fa-user"></i> </span>
                                                    <input class="form-control" placeholder="New password" name="new_pass" type="password">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group"> <span class="input-group-addon"> <i class="fa fa-lock"></i> </span>
                                                    <input class="form-control" placeholder="Confirm Password" name="con_pass" type="password">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="submit" class="btn btn-lg btn-block login_buton" value="Submit" name="reset_pass">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
