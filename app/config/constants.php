...
define('SITE_BASE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/SMGHealthAdmin/php/');
define('SITE_ASSETS_DIR', APPPATH.'/assets/site');
define('SITE_ASSETS_URI', SITE_BASE_URL.'assets/site');
...
define('DATETIME_QUERY_FORMAT', '%D %b, %Y at %r');
